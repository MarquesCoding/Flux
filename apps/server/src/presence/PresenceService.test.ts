...
describe('createPresenceService', () => {
  ...
  it('pauses a tab that is watching something, and tells it why', () => {
    ...
    expect(presence.list()).toMatchObject([{ playback: { isPlaying: false, pausedByAdmin: true } }])
  })
  ...
  it('resumes a paused tab', () => {
    ...
    expect(presence.list()).toMatchObject([{ playback: { isPlaying: true, pausedByAdmin: false } }])
  })
