...
/**
 * Puts Flux's icon in the dock, for the platform that takes it from the running application rather
 ...
 * given. A packaged Flux takes its own icon from its own bundle and never needs this, which is
