...
/**
 * Where this client has been told its Flux is, read from the same file the window writes it to.
 *
 ...
 * to offer it, and the server's Flux has no idea it is being looked at through a window that could
