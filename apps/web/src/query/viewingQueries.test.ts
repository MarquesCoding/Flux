...
vi.mock('@FluxWeb/playback/watchProgress', () => ({ fetchWatchProgress }));
vi.mock('@FluxWeb/library/fetchFavourites', () => ({ fetchFavourites }));
vi.mock('@FluxWeb/library/fetchRatings', () => ({ fetchRatings, fetchHouseholdRating }));
vi.mock('@FluxWeb/history/fetchHistory', () => ({ fetchHistory, A_PAGE: 2 }));
