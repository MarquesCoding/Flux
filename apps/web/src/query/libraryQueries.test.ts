...
vi.mock('@FluxWeb/library/fetchShows', () => ({ fetchShows, fetchShow }));
vi.mock('@FluxWeb/library/fetchFacets', () => ({ fetchFacets }));
vi.mock('@FluxWeb/library/fetchPerson', () => ({ fetchPerson, fetchPersonCredits }));
